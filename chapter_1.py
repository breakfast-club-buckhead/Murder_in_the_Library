...
name = input(" So..... What's your name anyway?")
print ("Okay, ", name, "get ready for a real whopper of a tale...")


print("Let's come up with a name. We need a name so we can call you.")
print (name, "What did you order to eat while participating in this story?")

#Nerando - put in what was ordered
food = input('Come on, tell me what you want to eat ? ')
print ('So %s is gonna have some %s' %(name,food ))
print('So back to the story ..... %s .... it was %s wasnt it ? ' %(name, name))
print('"Let me tell the story"....said the skull')

#What is the story  ? - Faith
